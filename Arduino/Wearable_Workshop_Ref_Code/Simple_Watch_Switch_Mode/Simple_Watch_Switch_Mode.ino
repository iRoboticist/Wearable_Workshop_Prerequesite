...
//Assigning pin numbers for Mode Button
const int ModeButton = 8;
/*Connect Button to Pin 8 to external 10K Ohm Pull-up resistor
Connect Switch between Pin 8 & GND*/
...
{ 
  ...
  // Screen must be refreshed at least once per second
      ...
      display.setCursor(0,10); //(0,0) will start from top left corner.
